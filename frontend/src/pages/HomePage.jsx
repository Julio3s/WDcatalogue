...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#F6F1EA] text-text-dark">
      ...
      <section className="relative overflow-hidden py-20 sm:py-28" style={{ background: 'linear-gradient(135deg, #E0F7FA 0%, #B2EBF2 50%, #80DEEA 100%)' }}>
        <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(circle at 20% 30%, #ffffff 0%, transparent 50%), radial-gradient(circle at 80% 70%, #ffffff 0%, transparent 50%)' }} />
        <div className="relative z-10 mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="text-2xl font-extrabold leading-[1.3] text-[#006064] sm:text-3xl lg:text-4xl">
            L’imagination n’a pas de limites…
            <span className="mt-1 block text-[#00838F]">et nos créations non plus !</span>
          </h2>
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#006064]/70 sm:text-lg">
          ...
          <div className="mt-8 flex justify-center">
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 rounded-full bg-[#00838F] px-8 py-4 text-sm font-bold text-white shadow-[0_8px_24px_rgba(0,131,143,0.3)] transition-all duration-300 hover:bg-[#006064] hover:shadow-[0_12px_32px_rgba(0,131,143,0.4)] active:scale-[0.98]"
            >
