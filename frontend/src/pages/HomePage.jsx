        ...
        <div className="relative z-10 mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 rounded-full bg-[#F5A623] px-9 py-4 text-base font-bold text-[#171311] transition hover:bg-[#E8A11E]"
            >
            ...
            <Link
              to="/products"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/25 px-7 py-4 text-sm font-bold text-white transition hover:border-[#F5A623] hover:text-[#F5A623]"
            >
