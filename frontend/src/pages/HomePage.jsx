        ...
        <div className="relative z-10 mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex justify-center">
            <a
              ...
              className="group inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#F5A623] to-[#E94560] px-8 py-4 text-sm font-extrabold uppercase tracking-wider text-white shadow-[0_8px_32px_rgba(233,69,96,0.35)] transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_12px_40px_rgba(233,69,96,0.5)] active:scale-[0.98]"
            >
