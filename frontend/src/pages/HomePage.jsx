...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#F6F1EA] text-text-dark">
      ...
      <section className="relative overflow-hidden bg-[#F6F1EA] py-20 sm:py-28">
        <div className="absolute inset-0" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'60\' height=\'60\' viewBox=\'0 0 60 60\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cg fill=\'none\' fill-rule=\'evenodd\'%3E%3Cg fill=\'%23A58A63\' fill-opacity=\'0.04\'%3E%3Cpath d=\'M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z\'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")' }} />
        <div className="relative z-10 mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <div className="relative mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
            <Sparkles className="h-7 w-7 text-[#E94560]" />
          </div>
          <h2 className="text-2xl font-extrabold leading-[1.3] text-[#171311] sm:text-3xl lg:text-4xl">
            L’imagination n’a pas de limites…
            <span className="mt-1 block text-[#A58A63]">et nos créations non plus !</span>
          </h2>
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-[#171311]/60 sm:text-lg">
          ...
          <div className="mt-8 flex justify-center">
            <a
              ...
              className="group inline-flex items-center justify-center gap-3 rounded-full border border-[#E5DDD4] bg-white px-8 py-4 text-sm font-semibold text-[#171311] shadow-[0_4px_16px_rgba(0,0,0,0.04)] transition-all duration-300 hover:border-[#A58A63] hover:text-[#A58A63] hover:shadow-[0_8px_24px_rgba(165,138,99,0.12)] active:scale-[0.98]"
            >
              <svg className="h-5 w-5 shrink-0 text-[#A58A63]" viewBox="0 0 24 24" fill="currentColor">
              ...
              <svg className="h-4 w-4 shrink-0 transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
